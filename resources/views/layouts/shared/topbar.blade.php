                ...
                <div class="modal-content modal-filled bg-success">
                    <div class="modal-body p-4">
                        <div class="text-center">
                            ...
                            <h4 class="mt-2 text-white">{{ __('Well Done!') }}</h4>
                            <p class="mt-3 text-white">{{ __('Data has been added successfully') }}.</p>
                            <button type="button" id="succ-btn" class="btn btn-light my-2" data-dismiss="modal">{{ __('Reload') }}</button>
                        </div>
                    </div>
                </div><!-- /.modal-content -->
            </div><!-- /.modal-dialog -->
