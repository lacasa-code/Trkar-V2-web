       ...
       <div class="navbar-custom">
        ...
        <ul class="list-unstyled topnav-menu float-right mb-0">
                        ...
                        <div class="dropdown-menu dropdown-lg dropdown-menu-right">
                            ...
                            <div class="p-lg-1">
                                ...
                                <div class="row no-gutters">
                                    ...
                                    <div class="col">
                                        <a class="dropdown-icon-item" href="#">
                                            <img src="assets/images/brands/g-suite.png"
                                                alt="G Suite">
                                            <span>G Suite</span>
                                        </a>
                                    </div>
                    ...
                    <li class="dropdown d-none d-lg-inline-block topbar-dropdown">
                        <a class="nav-link dropdown-toggle arrow-none waves-effect waves-light" data-toggle="dropdown"
                            href="#" role="button" aria-haspopup="false" aria-expanded="false">
                            <img src="assets/images/flags/us.jpg" alt="user-image"
                                height="16">
                        </a>
                ...
                <ul class="list-unstyled topnav-menu topnav-menu-left m-0">
                    <li>
                        <button @click ="addMenu" class="button-menu-mobile waves-effect waves-light">
                            <i class="fe-menu"></i>
                        </button>
                    </li>
...
export default {
   ...
   methods: {
      addMenu: function() {
         const myVar = document.getElementsByTagName("body")[0].getAttribute("data-sidebar-size");
    if(myVar === "default"){
